...
interface AdvancedTemplateEditorV2Props {
  project: UserProject;
...
export function AdvancedTemplateEditorV2({ project, onSave, onPublish, onNavigate }: AdvancedTemplateEditorV2Props) {
  ...
  return (
    <div className="h-screen flex bg-background">
      ...
      {/* Sidebar */}
      <div className="w-80 border-r bg-background pt-20 flex flex-col">
